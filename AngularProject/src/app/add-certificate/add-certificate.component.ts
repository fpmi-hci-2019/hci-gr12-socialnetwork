...
export class AddCertificateComponent implements OnInit {
  ...
  private modifyCertificate() {
    ...
    modify.duration = +this.form.value.duration;
  ...
  private initForm(defaultName?: string, defaultPrice?: number, defaultDescription?: string,
                   defaultDuration?: number, defaultTags?: Array<Tag>) {
    ...
    const duration = defaultDuration ? defaultDuration : null;
